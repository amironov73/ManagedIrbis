...
19227 8 MHL,'/K=/'(&uf(|G0(|v922^d),|%|d922/) 
19228 8 MHL,if v920:'J'then else'/K=/'(&uf(|G0(|v922^p),|%|d922/)fi 
19229 8 MHL,'/K=/'(&uf(|G0(|v922^r),|%|d922/) 
192210 8 MHL,'/K=/'(v922^i,|%|d922/)
192211 8 MHL,'/K=/'(v922^L,|%|d922/)
...
470 0 MHL,(if p(v470) then |A=|d470^a,if v470^a:', 'then v470^a else if v470^a:' 'then &unifor('G0 'v470^a),', '&unifor('G2 'v470^a) else v470^a fi fi,if &uf('Korg.mnu\A'):'1' then else |\реценз.док.\|d470^a fi fi,|%|d470/) 
...
6001 0 MHL,(if p(v600) then if p(v600^a) then 'A=',if p(v600^9) then if v600^9:'1' then v600^a else &unifor('E'v600^9,v600^a),|, |v600^g if a(v600^g) then if &unifor('F'v600^9,v600^a)<>'' then ', '&unifor('F'v600^9,v600^a) fi fi fi else if v600^a:' 'then if v600^a:','then v600^a else &unifor('G0 'v600^a)', 'v600^g,if a(v600^g) then &unifor('G2 'v600^a) fi fi else v600^a,|, |v600^g fi,fi,| |v600^d,if &uf('Ag700#1')='1' then else if s(v600^1,v600^c,v600^f)<>''then' (',v600^1,if s(v600^1)<>''then| ; |d600^c fi,v600^c,if s(v600^1,v600^c)<>''then| ; |d600^f fi,v600^f,')'fi,|\|v600^b|\| fi fi fi,|%|d600/)/ 
...
931 0 mhl,(|I=|v931^2/),(|I=|v931^3/),(|I=|v931^4/),(|I=|v904^a/),(|I=|v931^a/)
...
910 0 MHL,if v920='J' or v920='NJP'then else (if p(v910) then if v910^a:'4'then else if v910^a:'6' and a(v910^w) then |INS=|v910^b else |IN=|v910^b fi fi fi,|%|d910/) fi/
...
/*IBIS_KO
6911 0 MHL,(if p(v691) then if p(v691^w) and a(v691^u) then if s(v691^d,v691^i)<>''then'VUZD=',v691^d,if a(v691^d) then v691^i fi,' - 'v691^g,| ОСН |n691^g fi fi,fi,|%|d691/) 
691 0 MHL,(if p(v691) then |FAK=|v691^a/|FIL=|v691^L/|KAFV=|v691^h/|NAPR=|v691^N/|SPEC=|v691^C/|KAFCH=|v691^B/|DISC=|v691^D,if a(v691^D) then |DISC=|v691^i fi/|CIKLD=|v691^s/|KOMP=|v691^k/|VO=|v691^v/|TL=|v691^g/|FO=|v691^o fi,|%|d691/)/
...
910 0 (if p(v910) then if '1 4 6 2 7':v910^a then else if p(v910^s) then if p(v910^h) then |INPR=|v910^h, if 'C U':v910^a then  '('v910^0| из |, v910^1,')'  fi,fi/ if &uf('Av920#1')='NJ'or &uf('Av920#1')='NJP' then else if p(v910^b) then |INPR=|v910^b ,if 'C U':v910^a   then '('v910^0| из |, v910^1,')'fi,fi/ fi, 'INPF=', v910^!,,,,if a(v910^!)  then v910^d fi/,,,,,|INPD=|v910^s/,,,,,if p(v910^!) then |INPN=|v910^h| |,,,,if p(v910^h) then '('v910^!')' fi/ if &uf('Av920#1')='NJ'or &uf('Av920#1')='NJP' then else |INPN=|v910^b| |,,,if p(v910^b) then '('v910^!')' fi fi / fi fi fi fi|%|d910/)
...
/*IBIS_USER
2014 0 (if p(v2014^a) then 'IRKA=', v2014^a, /, fi)
2014 0 (if p(v2014^b) then 'IRKB=', v2014^b, /, fi)
2015 0 (if p(v2015) then 'NET=', v2015, /, fi)
2016 0 (if p(v2016) then 'SKBR=', v2016, /, fi)
2024 0 (if p(v2024) then 'TEMPLATE=', v2024, /, fi)
910 0 (if p(v910^9) then 'VNP=', v910^9, /, fi)
900 0 (if p(v900^z) then 'VOZ=', v900^z, /, fi)
110 0 (if p(v110^z) then 'VOZ=', v110^z, /, fi)
951 0 (if p(v951)   then 'ER=', v951^a, v951^i, /, fi)
1119 0 MHL, if p(v1119) then if rsum((if p(v910) then if v910^c<>'' then if (v910^a:'0') or (v910^a:'1') or (v910^a:'9') or (((v910^a:'U') or (v910^a:'C') or (v910^a:'C')) and (val(v910^1)>0)) or (v910^a:'8') or (v910^a:'3') then '1' else '0' fi fi fi/))>0 then 'GUID='v1119 fi fi
2021 0 (if p(v2021) then 'SBOR=', v2021, /, fi)
2022 0 (if p(v2022) then 'ETALON=', v2022, /, fi)
517 0 MHL,if v920='J' then (if p(v517^a) then 'TJ=', v517^a, /,fi) fi 
621 0 MHL,(|BBK=|v621^*,|%|d621/)(|BBK=|v330^5,|%|d330/)(|BBK=|v330^6,|%|d330/)(|BBK=|v330^7,|%|d330/)(|BBK=|v922^5,|%|d922/)(|BBK=|v922^6,|%|d922/)(|BBK=|v922^7,|%|d922)(|BBK=|v481^5,|%|d481/)(|BBK=|v481^6,|%|d481/)(|BBK=|v481^7,|%|d481/) 
883 0 (if p(v883) then 'CODE=',v883,/,fi)
884 0 (if p(v884) then 'MARS=',v884,/,fi)
907 0 iif v920='J' then else (if v907^b<>''then|TH=|v907^b,if v907^c:'штр'then|-|v907^c fi,|-|v907^a fi/if v907^a<>''then|TH=|v907^a,|-|v907^b fi,|%|d907/) fi 
907 0 (if s(v907^b,v907^c)<>'' then |TH=FETD=|v907^b,|-|v907^c,|-|v907^a/|TH=FETD=|v907^b,|-|v907^c,|-|v907^a.6/ fi,if s(v907^1,v907^c)<>'' then |TH=ODET=|v907^1,|-|v907^a.6,|-|v907^c/|TH=OETD=|v907^1,|-|v907^c,|-|v907^a/|TH=OETD=|v907^1,|-|v907^c,|-|v907^a.6/ fi,|%|d907) 
1001 0 mhl,(if p(v606^3) then |SNN=|v606^3,|%|d606 fi/)
6629 0 (|DBWEB=|v6629/,|%|d6629)
690 0 (if p(v690) then |SUK=|d690,&uf('+98 0'v690^l)fi/) 
931 0 if s(v931^!,v931^?)<>'' then (if p(v931) then |HRGMDNEW=|v931^!/|HRDMNEW=|v931^!*4.4/|HRGMDOLD=|v931^?/|HRMDOLD=|v931^?*4.4/if v931^?<>'' then |HRMD=|v931^?*4.4 else |HRMD=|v931^!*4.4 fi fi/|%|d931) fi
629 0 MHL,if p(v629^b) then if v629^b:'без' then 'KRV=3'/'KRV=MI' else if v629^b:'немест' then 'KRV=2'/'KRV=KRV' else if v629^b:'мест' then 'KRV=1'/'KRV=MI'/'KRV=KRV' else "KRV="v629^b fi fi fi fi/"UTL="v629^c/"KNL="v629^1 
606 0 MHL,(if p(v606^a) and p(v606^3) then'SKR='&unifor(|9|v606^a,| -- |v606^b,| -- |v606^c,| -- |v606^d,| -- |v606^g,| -- |v606^e,| -- |v606^o,|, |v606^h) fi,|%|d606/)
907 0 if s(v5,v907^a)<>''then 'LC='f(rmax((v5.8';',v907^a|;|/)),0,0) else 'LC=19000101'fi
910 0 if v920:'ASP' or v920:'J' then 'HAVE=1' else if v907:'ОБРНЗ' and (not v907:'obrzv') then 'HAVE=0' else if rsum((if p(v910) then if ((v910^a='0' or v910^a='1' or v910^a='9') and v910^h.1='E') or (v910^d='Ф403' or v910^d='Ф603') then '1;' else '0;'fi fi)) > 0 then 'HAVE=1' else 'HAVE=0' fi fi fi
924 0 (if p(v924) then 'T=', &unifor('9',v924), /, fi)
600 0 (if p(v600^z) then 'T=', &unifor('9',v600^z), /, fi)
910 0 (if p(v910^!) and p(v910^s) then 'INP=', v910^!, '-', v910^s, /, 'INP=', v910^!, '-', v910^s.6, /, fi)
931 0 (if p(v931) then if p(v931^?) then |G=|v931^? else |G=|v931^! fi fi/,|%|d931)
951 0 (if p(v951) then if v951^h='02a' or v951^h='02b' then else  if v951^1='' then 'DATECR='&uf('Av907^A#1') else |DATECR=|v951^1 fi fi fi/,|%|d951)
951 0 (if p(v951) then if v951^h='02a' or v951^h='02b' then |V=EXTCOVER|d951^h/ else |V=EXTRES|d951^a/|V=EXT|v951^h/if v951^5.1='!' then |V=EXTREFBAD|d951^i else |V=EXTREF|d951^i fi fi fi/,|%|d951)
951 0 (|DATECHEK=|v951^5/)
6628 0 (|VGRASP=|v6628/)