...
/*IBIS_INDEX
629 0 MHL,"KRV="d629,&unifor("9"v629^b)/"KRV=всего"d629
...
/*IBIS_KO
6911 0 MHL,(if p(v691) then if p(v691^w) and a(v691^u) then if s(v691^d,v691^i)<>''then'VUZD=',v691^d,if a(v691^d) then v691^i fi,' - 'v691^g,| ОСН |n691^g fi fi,|%|d691/) 
...
9227 0 MHL,(if p(v922) then |TP=|d922^d,&unifor(|9|v922^d),' \Паралл. загл.' fi,|%|d922/) 
9228 0 MHL,(if p(v922) then |TP=|d922^p,&unifor(|9|v922^p),' \Паралл. загл.' fi,|%|d922/) 
9229 0 MHL,(if p(v922) then |TP=|d922^r,&unifor(|9|v922^r),' \Паралл. загл.' fi,|%|d922/) 
