...
namespace IrbisMonitoringService
{
    class Program
    {
        ...
        private static void StartService()
        {
            try
            {
                ServiceController controller
                    = new ServiceController(MonitoringService.IrbisMonitoring);
                controller.Start();
            }
            catch (Exception ex)
            {
        ...
        private static void ShowVersion()
        {
            Console.WriteLine
                (
                    "IrbisMonitoringService - IBRIS64 monitoring service\n"
                    + "version {0}",
        ...
        {
            Console.WriteLine("IrbisMonitoringService version {0}", IrbisConnection.ClientVersion);
        ...
        private static void ShowHelp()
        {
            Console.WriteLine
                (
                    "IrbisMonitoringService - IRBIS64 monitoring service\n\n"
