...
namespace UnitTests.UnsafeAM.Collections
{
    ...
    public class DictionaryListTest
    {
        ...
        public void DictionaryList_Constructor()
        {
            ...
            ValuePair<string, int[]>[] items = list.ToArray();
        ...
        public void DictionaryList_Enumeration()
        {
            ...
            ValuePair<string, int[]>[] pairs = list.ToArray();
        ...
        public void DictionaryList_Serialization_1()
        {
            DictionaryList<string, int> list = new DictionaryList<string, int>();
            MemoryStream stream = new MemoryStream();
            BinaryWriter writer = new BinaryWriter(stream);
            list.SaveToStream(writer);
        }

        [TestMethod]
        [ExpectedException(typeof(NotImplementedException))]
        public void DictionaryList_Serialization_2()
        {
            DictionaryList<string, int> list = new DictionaryList<string, int>();
            MemoryStream stream = new MemoryStream();
            BinaryReader writer = new BinaryReader(stream);
            list.RestoreFromStream(writer);
        }
    }
}
