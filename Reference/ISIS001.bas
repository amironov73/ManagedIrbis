...
Global Const MAXMFRL = 32767          'max record length.
...
Type IsisSpaHeader
    ...
    fst             As String * MAXPATHLEN1     'fst file name.
    pft             As String * MAXPATHLEN1     'pft file name.
    fmt             As String * MAXPATHLEN1     'fmt file name.
    stw             As String * MAXPATHLEN1     'stw file name.
    fdt             As String * MAXPATHLEN1     'fdt file name.
    isoin           As String * MAXPATHLEN1     'import iso file name.
    isoout          As String * MAXPATHLEN1     'export iso file name.
    giz             As String * MAXPATHLEN1     'gizmo file name.
    dec             As String * MAXPATHLEN1     'decode file name.
...
Type IsisSrcRegExp
    ...
    Mfn             As Long
    Tag             As Long
    Expr            As String * SRC_EXPR_LENGTH1
...
Global Const ERR_FILEEOF = -217         ' File eof.
...
Global Const ERR_LLJISISETRAP = -303    ' JIsis Low Level Error Trap.
Global Const ERR_LLCORBAETRAP = -304    ' Corba Low Level Error Trap.
Global Const ERR_LLPHPISISETRAP = -305  ' PHP Low Level Error Trap.
...
Global Const ERR_PARFILNSIZ = -502      ' Invalid file name size.
...
Global Const NONE = 0                   ' No file available.

Global Const MAST = 3                   ' Master available.
Global Const MST_ = 1                   ' *.mst available.
Global Const XRF_ = 2                   ' *.xrf available.

Global Const INVE = 252                 ' Inverted available.
Global Const CNT_ = 4                   ' *.cnt available.
Global Const N01_ = 8                   ' *.n01 available.
Global Const N02_ = 16                  ' *.n02 available.
Global Const L01_ = 32                  ' *.l01 available.
Global Const L02_ = 64                  ' *.l02 available.
Global Const IFP_ = 128                 ' *.ifp available.

Global Const FST_ = 256                 ' *.fst available.
Global Const PFT_ = 512                 ' *.pft available.
Global Const FMT_ = 1024                ' *.fmt available.
Global Const STW_ = 2048                ' *.stw available.
Global Const FDT_ = 4096                ' *.fdt available.

Global Const ISOI = 8192                ' ISO import available.
Global Const ISOE = 16384               ' ISO export available.

Global Const PAR_ = 32738               ' *.par available.

Global Const GIZM = 65536               ' Gizmo  available.
Global Const DECO = 131072              ' Decode available.

Global Const ANY_ = 16777216            ' *.any available.

Global Const ALL_ = 4294967296#         ' All files available.
...
'  00000000 00000000 00000100 00000000       1024 =          *.fmt
'  00000000 00000000 00001000 00000000       2048 =          *.stw
'  00000000 00000000 00010000 00000000       4096 =          *.fdt
'  00000000 00000000 00100000 00000000       8192 = ISO in   *.iso
'  00000000 00000000 01000000 00000000      16384 = ISO out  *.iso
'  00000000 00000000 10000000 00000000      32738 = Cipar    *.par

'  00000000 00000001 00000000 00000000      65536 = Gizmo
'  00000000 00000010 00000000 00000000     131072 = Decode
