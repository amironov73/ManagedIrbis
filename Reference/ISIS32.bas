...
Declare Function IsisRecDumpXml Lib "isis32.dll" (ByVal Handle&, ByVal Index&, ByVal FieldArea$, ByVal AreaSize&) As Long
...
Declare Function IsisRecUpdateXml Lib "isis32.dll" (ByVal Handle&, ByVal Index&, ByVal FieldArea$) As Long
