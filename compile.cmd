...
rem CALL :BUILDLIB %%P %%B 35  v3.5   "CLASSIC;DESKTOP;FW35"
rem CALL :BUILDLIB %%P %%B 40  v4.0   "CLASSIC;DESKTOP;FW4;FW40"
...
FOR %%P IN (mx64,PftBench) DO (
  FOR %%B IN (Debug,Release) DO (
rem CALL :BUILDAPP %%P %%B 40  v4.0   "CLASSIC;DESKTOP;FW4;FW40"
    CALL :BUILDAPP %%P %%B 45  v4.5   "CLASSIC;DESKTOP;FW4;FW45"
rem CALL :BUILDAPP %%P %%B 46  v4.6   "CLASSIC;DESKTOP;FW4;FW46"
  )
)
